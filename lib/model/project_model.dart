...
List<Project> projectList = [
  Project(
    ...
    'https://github.com/Vijay-Malethia/Coffe-Shop-Beautifull-UI',
  ),
  Project(
    ...
    'https://github.com/Vijay-Malethia/Car-Controller-Getx-Flutter',
  ),
  Project(
      'Neumorphic Clockify',
      ...
      'https://github.com/Vijay-Malethia/Neumorphic-Analog-Clockify'),
  Project(
      'CUI Aider',
      ...
      'https://github.com/Vijay-Malethia/'),
  Project(
      ...
      'https://github.com/Vijay-Malethia/Neumorphic-Music_Player-Flutter'),
  Project(
      'Food Recipe App',
      ...
      'https://github.com/Vijay-Malethia/Food-Recipe-App-Flutter'),
  Project(
      'Task Sync Pro',
      ...
      'https://github.com/Vijay-Malethia/Task-Sync-Pro-Flutter'),
  Project(
      ...
      'https://github.com/Vijay-Malethia/Messenger-App-Backend-Firebase'),
  Project(
      ...
      'https://github.com/Vijay-Malethia/Doctor-Appointment-Application-UI'),
];
